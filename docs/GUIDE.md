...
> tests plus de 100 fois plus lents (178 s contre 1,2 s pour les tests). Placez-le par exemple dans
> `~/dev/voxjev`. Par précaution, le lanceur `./voxjev` place quand même les caches `.pyc`
